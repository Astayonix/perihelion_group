...
#     industry = db.relationship('Industry', backref=db.backref('stock'))
...
#     ticker_symbol = db.relationship('Stock', backref=db.backref('stock_quote_summaries'))
...
#     ticker_symbol = db.Column(db.String(15), db.ForeignKey('Stock.ticker_symbol'))

#     user_id = db.relationship('User', backref=db.backref('stock_users'))
#     ticker_symbol = db.relationship('Stock', backref=db.backref('stock_users'))
